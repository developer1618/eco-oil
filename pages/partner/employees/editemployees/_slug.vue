    ...
    <div class="grid px-8 py-10 grid-cols-2 bg-white h-[85vh]">
      <ValidationObserver v-slot="{ handleSubmit }">
        <h3 class="text-sm font-medium text-dark pb-10">
          CОТРУДНИКИ (РОСТ ОИЛ) / РЕДАКТИРОВАНИЕ СОТРУДНИКА
        </h3>
        <form
        ...
        >
          ...
          <div class="col-span-2">
            <ValidationProvider rules="required" v-slot="{ errors }">
              <label
                for="helper-text"
                class="block mb-2 text-sm font-medium text-[#4D5D7D]"
                >Лимит <span class="text-red-600 absolute"></span
              ></label>
              <input
                type="number"
                v-model="name_ru"
          ...
          <div class="col-span-4">
            <div class="flex items-center pb-4">
              <label class="text-sm font-medium text-[#6B7280]"
                >Вид топлива</label
              >
            </div>
            <div class="flex">
          ...
          <div class="flex col-span-4 navbtn">
            ...
            <div class="navdelbtn">
              <nuxt-link
                to="#"
                type="button"
                class="navdelbtn text-[#4D5D7D] border border-[#F44336] text-[#F44336] hover:bg-[#F44336] hover:text-[#fff] focus:outline-none focus:ring-gray-200 font-medium rounded-lg hover:rounded-lg text-sm px-8 py-2.5 hover:px-8 hover:py-2.5 mr-2 mb-2"
                >Удалить</nuxt-link
              >
            </div>
