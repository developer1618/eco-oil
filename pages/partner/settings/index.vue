                ...
                <form class="grid grid-cols-4 gap-8" @submit.prevent="handleSubmit(getStations)">
                    <div class="col-span-2">
                        <ValidationProvider rules="required" v-slot="{ errors }">
                            <label for="helper-text" class="block mb-2 text-sm font-medium text-[#4D5D7D]">Название компании<span class="text-red-600 absolute"></span></label>
                            <input type="text" v-model="name_ru" id="helper-text" v-on:keypress="isLetter($event)" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5 placeholder-[#B3B9C9] text-[#4D5D7D] focus:ring-blue-500 focus:border-blue-500" placeholder="Введите Название компании">
