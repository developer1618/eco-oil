    ...
    <div class="grid px-8 py-10 grid-cols-2 bg-white h-[85vh]">
      <ValidationObserver v-slot="{ handleSubmit }">
        <h3 class="text-sm font-medium text-dark pb-10">
          ПАРТНЁРЫ / ДОБАВЛЕНИЕ ПАРТНЁРА
        </h3>
        <form
          class="grid grid-cols-4 gap-8"
          @submit.prevent="handleSubmit(getPartner)"
        >
          <div class="col-span-2">
            <ValidationProvider rules="required" v-slot="{ errors }">
              <label
                ...
                >Партнёр<span class="text-red-600 absolute"></span
              ></label>
              <input
                type="text"
                v-model="form.name"
          ...
          <div class="col-span-2">
            <ValidationProvider rules="required" v-slot="{ errors }">
              <label
                for="helper-text"
                class="block mb-2 text-sm font-medium text-[#4D5D7D]"
                >Логин<span class="text-red-600 absolute"></span
              ></label>
              <input
                type="text"
          ...
          <div class="col-span-2">
            <ValidationProvider rules="required" v-slot="{ errors }">
              <label
                for="helper-text"
                class="block mb-2 text-sm font-medium text-[#4D5D7D]"
                >Адрес <span class="text-red-600 absolute"></span
              ></label>
              <input
                type="text"
          ...
          <div class="col-span-2">
            <ValidationProvider rules="required" v-slot="{ errors }">
              <label
                for="helper-text"
                class="block mb-2 text-sm font-medium text-[#4D5D7D]"
                >Баланс (TJS) <span class="text-red-600 absolute"></span
              ></label>
              <input
                type="number"
