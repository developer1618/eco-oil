                ...
                <form class="grid grid-cols-4 gap-8" @submit.prevent="handleSubmit(getPartner)">
                    <div class="col-span-2">
                        <ValidationProvider rules="required" v-slot="{ errors }">
                            <label for="helper-text" class="block mb-2 text-sm font-medium text-[#4D5D7D]">Партнёр<span class="text-red-600 absolute"></span></label>
                    ...
                    <div class="col-span-2">
                        <ValidationProvider rules="required" v-slot="{ errors }">
                            <label for="helper-text" class="block mb-2 text-sm font-medium text-[#4D5D7D]">Логин<span class="text-red-600 absolute"></span></label>
                    ...
                    <div class="col-span-2">
                        <ValidationProvider rules="required" v-slot="{ errors }">
                            <div class="relative">
                                <label for="password" class="block mb-2 text-sm font-medium text-[#4D5D7D]">Пароль <span class="text-red-600 absolute"></span></label>
                    ...
                    <div class="col-span-2">
                        <ValidationProvider rules="required" v-slot="{ errors }">
                            <label for="helper-text" class="block mb-2 text-sm font-medium text-[#4D5D7D]">Адрес <span class="text-red-600 absolute"></span></label>
                    ...
                    <div class="col-span-2">
                        <ValidationProvider rules="required" v-slot="{ errors }">
                            <label for="helper-text" class="block mb-2 text-sm font-medium text-[#4D5D7D]">Баланс (TJS) <span class="text-red-600 absolute"></span></label>
                            <input type="number" v-model="form.balance" id="helper-text" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5 placeholder-[#B3B9C9] text-[#4D5D7D] focus:ring-blue-500 focus:border-blue-500" placeholder="Введите допустимый баланс">
                            <p class="text-red-600 absolute">{{errors[0]}}</p>
                        </ValidationProvider>
                    </div>
