                ...
                <form class="grid grid-cols-4 gap-8" @submit.prevent="handleSubmit(getStations)">
                    <div class="col-span-2">
                        <ValidationProvider rules="required" v-slot="{ errors }">
                            ...
                            <input type="text" v-model="name_ru" id="helper-text" v-on:keypress="isLetter($event)" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5 placeholder-[#B3B9C9] text-[#4D5D7D] focus:ring-blue-500 focus:border-blue-500" placeholder="Введите имя">
                    ...
                    <div class="col-span-2">
                        <ValidationProvider rules="required" v-slot="{ errors }">
                            ...
                            <input type="text" v-model="lastname_ru" id="helper-text" v-on:keypress="isLetter($event)" aria-describedby="helper-text-explanation" class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5 placeholder-[#B3B9C9] text-[#4D5D7D] focus:ring-blue-500 focus:border-blue-500" placeholder="Введите Фамилию">
                            <p class="text-red-600">{{errors[0]}}</p>
                        </ValidationProvider>
                    </div>
                    <div class="col-span-2">
                    ...
                    <div class="col-span-4 navbtn">
                        ...
                        <nuxt-link to="/admin/scoreboard" type="button" class="text-[#4D5D7D] border border-[#009688] text-[#009688] hover:bg-[#009688] hover:text-[#fff] focus:outline-none focus:ring-gray-200 font-medium rounded-lg hover:rounded-lg text-sm px-8 py-2.5 hover:px-8 hover:py-2.5 mr-2 mb-2">Назад</nuxt-link>
