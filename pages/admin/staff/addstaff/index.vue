    ...
    <div class="grid px-8 py-10 grid-cols-2 bg-white h-[85vh]   ">
      <ValidationObserver v-slot="{ handleSubmit }">
        ...
        <form
          ...
          @submit.prevent="handleSubmit(addStuff)"
        >
          ...
          <div class="col-span-2">
            <ValidationProvider rules="required" v-slot="{ errors }">
              <label
                for="helper-text"
                class="block mb-2 text-sm font-medium text-[#4D5D7D]"
                >Логин<span class="text-red-600"></span></label
              >
              <input
                type="text"
            ...
            <div class="flex flex-wrap">
                ...
                <div class="flex">
                    <div class="flex items-center mr-4">
                        <input id="red-radio" type="radio" value="1" name="colored-radio" class="w-4 h-4 bg-gray-100 border-gray-300">
                        <label for="red-radio" class="ml-2 text-sm font-medium text-gray-500">Активный</label>
                    </div>
                    <div class="flex items-center mr-4">
                        <input id="green-radio" type="radio" value="0" name="colored-radio" class="w-4 h-4 bg-gray-100 border-gray-300">
